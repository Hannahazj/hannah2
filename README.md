...
table.componennt.html "<!-- <div class="form-group">
  <input
    type="search"
    class="form-control"
    [(ngModel)]="filter"
...
@ViewChild('searchInput') searchInput!: ElementRef<HTMLInputElement>;
  ...
  updateFilter(){
    ...
    // TODO: add the docs cosmo endpoint
    // sorts documents 
...
/*   updateFilter(){
  ...
  getDocumentInfo(){
    ...
    this.apiService.postGetDocsCosmos(this.filter, this.selectedEntity, 800).subscribe(result => {
      ...
      // TODO: add a backend filter instead of front end filter
