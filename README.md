                            ...
                            <div class="query-row" *ngIf="sectionIndex === currentSection">
                                <form class="input-container" 
                                    ...
                                    <form [formGroup]="sectionSettingsForm" (ngSubmit)="testForm()">
                                        ...
                                        <!-- SPEAKING NOTES HEADER EDITOR (only shows for speaking_notes) -->
                                        <div class="speaking-header-editor" *ngIf="selectedSectionType?.section_type === 'speaking_notes'">
                                          <div class="form-row">
                                          ...
                                          <div class="form-row">
                                            <button type="button" class="btn btn-outline-secondary settings-dropdown"
                                                    (click)="applySpeakingHeaderFromControls()">
                                              Apply Header
                                            </button>
                                          </div>
                                        </div>
                                        <!-- END SPEAKING NOTES HEADER EDITOR -->
