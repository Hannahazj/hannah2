                ...
                <div class="flex">
                    ...
                    <div class="section-column">
                        <div class="section-card"  (click)="selectSection(sectionIndex, $event)"  
                            ...
                            <!-- SPEAKING NOTES header controls: only show if speaking mode and on Header section -->
                            <div class="query-row" *ngIf="speakingModeActive && section?.section_name === 'Header' && sectionIndex === currentSection">
                            ...
                            <!-- END SPEAKING NOTES header controls -->
